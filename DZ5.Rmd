...
Интерактивная картограмма на данных Всемирного Банка по [сетевой миграции населения](https://data.worldbank.org/indicator/SM.POP.NETM?view=chart) за 2017 год.     

```{r Интерактивная картограмма, results = 'asis', cashe = T}
# данные по сетевой миграции
